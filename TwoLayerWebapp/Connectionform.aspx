<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Connectionform.aspx.cs" Inherits="TwoLayerWebapp.Connectionform" %>
    ...
    <form id="form1" runat="server">
        <table class="auto-style1">
            ...
            <tr>
                ...
                <td>Username</td>
                <td>
                    <asp:TextBox ID="TextBox4" runat="server" Width="111px"></asp:TextBox>
                </td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            ...
            <tr>
                ...
                <td>Password</td>
                <td>
                    <asp:TextBox ID="TextBox5" runat="server" Width="113px"></asp:TextBox>
                </td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
